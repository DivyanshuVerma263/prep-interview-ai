  ...
  return (
    <section className="py-24">
      <div className="container flex items-center justify-center">
        <div className="grid w-full growitems-center px-4 sm:justify-center">
          <SignUp.Root>
            <Clerk.Loading>
              {(isGlobalLoading) => (
                <>
                  <SignUp.Step name="start">
                    ...
                    <Card className="w-full sm:w-96">
                      ...
                      <CardHeader>
                        <CardTitle className="text-xl">Sign up to <span className="text-primary"> Prep Interview AI</span> </CardTitle>
                      ...
                      <CardFooter>
                        <div className="grid w-full gap-y-4">
                          ...
                          <Button variant="link" size="sm" asChild>
                            <Link href="/sign-in" className="text-black dark:text-white hover:text-primary dark:hover:text-primary">Already have an account? Sign in</Link>
                          </Button>
                        </div>
                      </CardFooter>
