                ...
                <>
                  <SignIn.Step name="start">
                    <Card className="w-full sm:w-96">
                      <CardHeader>
                        <CardTitle className="text-xl">Sign in to <span className="text-primary"> Prep Interview AI</span> </CardTitle>
                      ...
                      <CardFooter>
                        <div className="grid w-full gap-y-4">
                          ...
                          <Button variant="link" size="sm" asChild>
                            <Link href="/sign-up" className="text-black dark:text-white hover:text-primary dark:hover:text-primary">Don&apos;t have an account? Sign up</Link>
                          </Button>
                        </div>
                      </CardFooter>
                    </Card>
